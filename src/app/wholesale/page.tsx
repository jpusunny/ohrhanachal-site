      ...
      <section className="hero">
        <div className="wrap">
          <div className="hero-copy">
            ...
            <p className="kicker">Bulk &amp; Wholesale</p>
            <h1>Fill the beis medrash, not just the <em>shelf.</em></h1>
            <p className="lead">Outfitting a shul, yeshiva, or mosad? Buy direct from the press at volume pricing — full cases of any sefer, matched sets, and custom leather bindings, shipped on a schedule that fits your zman.</p>
            <div className="hero-cta">
              <a className="btn btn--gold" href="/wholesale/signup">Open an account</a>
              <a className="btn btn--outline" href="/wholesale/login">Sign in</a>
            </div>
          </div>
          <div className="hero-figure framed">
